...
class DataBase:
    ...
    def donateFoodDetails(self,foodItem,quantity,location,mode):
        query = "INSERT INTO user_info(donar,donar_email,donar_address,donar_phonenumber,donation_item,donation_quantity,location, donation_mode) VALUES(%s,%s,%s,%s,%s,%s,%s,%s)"
