...
class HomePage:
    ...
    def indexPage():
        donationsDictionary1 = {}
        donationsDictionary1 = request.args.get('donationsDictionary')
        print("Dictionary is ",donationsDictionary1)
        return render_template("index.html",donationsDictionary1 = donationsDictionary1)
